...
const PHARMASIS_TRANSLATIONS = {
    ...
    en: {
        ...
        voice_tap_to_speak: 'Tap to speak (any language)',
        voice_recording_tap_stop: 'Recording: tap to stop',
        voice_preparing_questions: 'Preparing clinical questions...',
        voice_active_transcription: 'Voice transcription active',
        voice_recording_badge: 'Recording',
        search_medicine_placeholder: 'Search by medicine name...',
        search_button: 'Search',
        screening_header_title: 'Symptom Screening',
        screening_question_of: 'Question {0} of {1}',
        screening_your_symptoms: 'Your symptoms',
        screening_select_multiple: 'You can select more than one',
        screening_freetext_placeholder: 'Add your own details here (optional)...',
        screening_btn_back: 'Back',
        screening_btn_continue: 'Continue',
        screening_btn_skip: 'Skip',
        screening_final_step: 'Final step',
        screening_doctor_card_title: 'Doctor / Healthcare Provider',
        screening_doctor_card_desc: 'Detailed clinical conclusion: differential diagnosis, drug regimen, interactions, and management.',
        screening_patient_card_title: 'Patient / General Public',
        screening_patient_card_desc: 'A reassuring explanation, self-care, lifestyle tips, and guidance to a doctor.',
        concluding_building: 'Building conclusion...',
        concluding_step1_label: 'Summarizing your answers',
        concluding_step1_detail: 'Building the screening transcript · recognizing clinical entities',
        concluding_step2_label: 'Forming a likely condition',
        concluding_step2_detail: 'Differential diagnosis · clinical reasoning',
        concluding_step3_label: 'Building recommendations',
        concluding_step3_detail: 'Medicines / care · safety · next steps',
        concluding_step4_label: 'Conclusion ready to display',
        concluding_step4_detail: 'Validated JSON · report tailored to your role',
        concluding_wait: 'Please wait, preparing a conclusion tailored to your role...',
        result_report_clinical: 'Clinical Report',
        result_report_health: 'Health Report',
        result_new_analysis: 'New Analysis',
        result_symptoms_described: 'The symptoms you described',
        result_differential_title: 'Differential Diagnosis',
        result_differential_desc: 'Possible differentials based on the screening results',
        result_regimen_title: 'Pharmacologic Regimen',
        result_regimen_desc: 'Tap a medicine name for full details',
        result_interactions_title: 'Drug Interactions',
        result_management_title: 'Management',
        result_redflags_title: 'Red Flags',
        result_summary_title: 'Clinical Summary',
        result_export_pdf_title: 'Clinical document',
        result_export_pdf_desc: 'Export this formal summary for medical records or referrals.',
        result_export_pdf_btn: 'Clinical PDF',
        result_likely_condition: 'Likely Condition',
        result_selfcare_title: 'Self-Care',
        result_lifestyle_title: 'Lifestyle Adjustments',
        result_seek_care_title: 'When to Seek Medical Care',
        result_should_see_title: 'You Should See',
        result_what_to_ask_title: 'What to Ask Your Doctor',
        result_facilities_title: 'Nearby Healthcare Facilities',
        result_disclaimer: 'This report is for educational purposes only. Always consult a healthcare professional.',
        result_btn_copy: 'Copy Report',
        result_btn_copied: 'Copied to Clipboard!',
        result_btn_share: 'Share',
        result_btn_save_pdf: 'Save PDF',
        result_btn_start_over: 'Start Over',
        kiosk_title: 'Finished reading?',
        kiosk_desc: 'This page will reset automatically in {0} seconds so it is ready for the next person.',
        kiosk_wait: 'Wait',
        kiosk_done: 'Done',
        kiosk_hint: '"Wait" adds 1 more minute · "Done" starts over right away',
        mc_facts_badge: 'Medical Facts',
        mc_combo_badge: 'Facts + Screening',
        mc_patient_header: 'For Patient / General Public',
        mc_self_care_header: 'Self-Care Steps',
        mc_recommended_doctor: 'Recommended Doctor:',
        mc_mode_clinician: 'Clinician Mode (Doctor / Healthcare Professional)',
        mc_emergency_title: 'Medical Emergency Condition',
        mc_emergency_detected: 'Detected by MediCore AI',
        mc_emergency_call_119: 'Call Emergency',
        mc_back: 'Back',
    ...
    id: {
        ...
        voice_tap_to_speak: 'Ketuk untuk bicara (semua bahasa)',
        voice_recording_tap_stop: 'Merekam: ketuk untuk berhenti',
        voice_preparing_questions: 'Menyiapkan pertanyaan klinis...',
        voice_active_transcription: 'Transkripsi suara aktif',
        voice_recording_badge: 'Merekam',
        search_medicine_placeholder: 'Cari berdasarkan nama obat...',
        search_button: 'Cari',
        screening_header_title: 'Skrining Gejala',
        screening_question_of: 'Pertanyaan {0} dari {1}',
        screening_your_symptoms: 'Gejala Anda',
        screening_select_multiple: 'Anda dapat memilih lebih dari satu',
        screening_freetext_placeholder: 'Tambahkan detail Anda di sini (opsional)...',
        screening_btn_back: 'Kembali',
        screening_btn_continue: 'Lanjutkan',
        screening_btn_skip: 'Lewati',
        screening_final_step: 'Langkah terakhir',
        screening_doctor_card_title: 'Dokter / Tenaga Medis',
        screening_doctor_card_desc: 'Kesimpulan klinis mendalam: diagnosis banding, regimen obat, interaksi, dan tata laksana.',
        screening_patient_card_title: 'Pasien / Masyarakat Umum',
        screening_patient_card_desc: 'Penjelasan menenangkan, langkah mandiri, anjuran gaya hidup, dan rujukan dokter.',
        concluding_building: 'Menyusun kesimpulan...',
        concluding_step1_label: 'Merangkum jawaban skrining',
        concluding_step1_detail: 'Menyusun transkrip skrining · mengenali entitas klinis',
        concluding_step2_label: 'Menganalisis kemungkinan kondisi',
        concluding_step2_detail: 'Diagnosis banding · penalaran klinis',
        concluding_step3_label: 'Menyusun rekomendasi',
        concluding_step3_detail: 'Rekomendasi obat / perawatan · keamanan · langkah berikutnya',
        concluding_step4_label: 'Kesimpulan siap ditampilkan',
        concluding_step4_detail: 'JSON tervalidasi · laporan disesuaikan dengan peran Anda',
        concluding_wait: 'Mohon tunggu, menyiapkan kesimpulan yang disesuaikan dengan peran Anda...',
        result_report_clinical: 'Laporan Klinis',
        result_report_health: 'Laporan Kesehatan',
        result_new_analysis: 'Analisis Baru',
        result_symptoms_described: 'Gejala yang Anda deskripsikan',
        result_differential_title: 'Diagnosis Banding',
        result_differential_desc: 'Kemungkinan diagnosis banding berdasarkan hasil skrining',
        result_regimen_title: 'Regimen Farmakologis',
        result_regimen_desc: 'Ketuk nama obat untuk melihat detail lengkap',
        result_interactions_title: 'Interaksi Obat',
        result_management_title: 'Tata Laksana',
        result_redflags_title: 'Tanda Bahaya (Red Flags)',
        result_summary_title: 'Ringkasan Klinis',
        result_export_pdf_title: 'Dokumen Klinis',
        result_export_pdf_desc: 'Ekspor ringkasan formal ini untuk rekam medis atau rujukan.',
        result_export_pdf_btn: 'PDF Klinis',
        result_likely_condition: 'Kemungkinan Kondisi',
        result_selfcare_title: 'Perawatan Mandiri',
        result_lifestyle_title: 'Penyesuaian Gaya Hidup',
        result_seek_care_title: 'Kapan Harus ke Dokter',
        result_should_see_title: 'Dokter yang Disarankan',
        result_what_to_ask_title: 'Pertanyaan untuk Dokter Anda',
        result_facilities_title: 'Fasilitas Kesehatan Terdekat',
        result_disclaimer: 'Laporan ini hanya untuk tujuan edukasi. Selalu konsultasikan dengan tenaga medis profesional.',
        result_btn_copy: 'Salin Laporan',
        result_btn_copied: 'Tersalin ke Clipboard!',
        result_btn_share: 'Bagikan',
        result_btn_save_pdf: 'Simpan PDF',
        result_btn_start_over: 'Mulai Ulang',
        kiosk_title: 'Selesai membaca?',
        kiosk_desc: 'Halaman ini akan direset otomatis dalam {0} detik agar siap untuk orang berikutnya.',
        kiosk_wait: 'Tunggu',
        kiosk_done: 'Selesai',
        kiosk_hint: '"Tunggu" menambah 1 menit · "Selesai" langsung mereset sekarang',
        mc_facts_badge: 'Fakta Medis',
        mc_combo_badge: 'Fakta + Skrining',
        mc_patient_header: 'Untuk Pasien / Masyarakat Umum',
        mc_self_care_header: 'Langkah Perawatan Mandiri',
        mc_recommended_doctor: 'Dokter yang disarankan:',
        mc_mode_clinician: 'Mode Klinisi (Dokter / Tenaga Medis)',
        mc_emergency_title: 'Kondisi Darurat Medis',
        mc_emergency_detected: 'Terdeteksi oleh MediCore AI',
        mc_emergency_call_119: 'Hubungi 119',
        mc_back: 'Kembali',
    ...
    ja: {
        ...
        voice_tap_to_speak: 'タップして話す（多言語対応）',
        voice_recording_tap_stop: '録音中: タップで停止',
        voice_preparing_questions: '臨床問診を生成しています...',
        voice_active_transcription: '音声認識が有効です',
        voice_recording_badge: '録音中',
        search_medicine_placeholder: '医薬品名で検索...',
        search_button: '検索',
        screening_header_title: '症状スクリーニング',
        screening_question_of: '質問 {0} / {1}',
        screening_your_symptoms: 'ご入力いただいた症状',
        screening_select_multiple: '複数選択が可能です',
        screening_freetext_placeholder: '詳しい状況を追加（任意）...',
        screening_btn_back: '戻る',
        screening_btn_continue: '次へ進む',
        screening_btn_skip: 'スキップ',
        screening_final_step: '最終ステップ',
        screening_doctor_card_title: '医師・医療従事者向け',
        screening_doctor_card_desc: '鑑別診断、推奨処方薬、相互作用、臨床管理指針を含む詳細な医療レポート。',
        screening_patient_card_title: '患者・一般の方向け',
        screening_patient_card_desc: '分かりやすい解説、セルフケア、生活習慣のアドバイス、受診の目安。',
        concluding_building: '臨床評価を作成中...',
        concluding_step1_label: '回答内容の要約と整理',
        concluding_step1_detail: '問診ログの構築 · 臨床エンティティの認識',
        concluding_step2_label: '考えられる疾患の臨床推論',
        concluding_step2_detail: '鑑別診断の立案 · 重症度評価',
        concluding_step3_label: '治療・ケア方針の策定',
        concluding_step3_detail: '推奨医薬品 / ケア · 安全性確認 · 次のステップ',
        concluding_step4_label: '臨床評価の準備完了',
        concluding_step4_detail: '検証済みJSON · 選択された役割に応じたレポート',
        concluding_wait: '役割に合わせた評価レポートを作成しています。少々お待ちください...',
        result_report_clinical: '臨床レポート',
        result_report_health: '健康レポート',
        result_new_analysis: '新しい分析を開始',
        result_symptoms_described: '入力された症状の内容',
        result_differential_title: '鑑別診断',
        result_differential_desc: 'スクリーニングに基づく可能性のある鑑別疾患',
        result_regimen_title: '薬物療法レジメン',
        result_regimen_desc: '医薬品名をタップして詳細情報を確認',
        result_interactions_title: '薬物相互作用',
        result_management_title: '臨床マネジメント方針',
        result_redflags_title: '注意すべき警戒兆候 (Red Flags)',
        result_summary_title: '臨床サマリー',
        result_export_pdf_title: '臨床文書エクスポート',
        result_export_pdf_desc: '診療録や紹介状向けにフォーマルなサマリーを出力できます。',
        result_export_pdf_btn: '臨床PDF出力',
        result_likely_condition: '可能性のある病状',
        result_selfcare_title: 'セルフケアと対処法',
        result_lifestyle_title: '生活習慣の改善点',
        result_seek_care_title: '医療機関を受診すべきタイミング',
        result_should_see_title: '推奨される診療科',
        result_what_to_ask_title: '医師への質問リスト',
        result_facilities_title: '近隣の医療機関',
        result_disclaimer: '本レポートは教育・情報提供を目的としています。医療上の判断は必ず医師にご相談ください。',
        result_btn_copy: 'レポートをコピー',
        result_btn_copied: 'クリップボードにコピーしました！',
        result_btn_share: '共有する',
        result_btn_save_pdf: 'PDFを保存',
        result_btn_start_over: '最初からやり直す',
        kiosk_title: '確認が終わりましたか？',
        kiosk_desc: '次の利用者のために、このページは {0} 秒後に自動的にリセットされます。',
        kiosk_wait: '延長する',
        kiosk_done: '完了',
        kiosk_hint: '「延長する」で1分延長 · 「完了」で直ちにリセット',
        mc_facts_badge: '医学的事実',
        mc_combo_badge: '事実 + スクリーニング',
        mc_patient_header: '患者・一般の方向け情報',
        mc_self_care_header: 'セルフケアの手引き',
        mc_recommended_doctor: '推奨される診療科:',
        mc_mode_clinician: '臨床医モード (医師・医療従事者)',
        mc_emergency_title: '緊急性の高い医療状態',
        mc_emergency_detected: 'MediCore AIにより検出',
        mc_emergency_call_119: '緊急通報 (119)',
        mc_back: '戻る',
    ...
    es: {
        ...
        voice_tap_to_speak: 'Toca para hablar (cualquier idioma)',
        voice_recording_tap_stop: 'Grabando: toca para detener',
        voice_preparing_questions: 'Preparando preguntas clínicas...',
        voice_active_transcription: 'Transcripción de voz activa',
        voice_recording_badge: 'Grabando',
        search_medicine_placeholder: 'Buscar por nombre de medicamento...',
        search_button: 'Buscar',
        screening_header_title: 'Evaluación de Síntomas',
        screening_question_of: 'Pregunta {0} de {1}',
        screening_your_symptoms: 'Tus síntomas',
        screening_select_multiple: 'Puedes seleccionar más de una opción',
        screening_freetext_placeholder: 'Añade más detalles aquí (opcional)...',
        screening_btn_back: 'Atrás',
        screening_btn_continue: 'Continuar',
        screening_btn_skip: 'Omitir',
        screening_final_step: 'Paso final',
        screening_doctor_card_title: 'Médico / Profesional de la Salud',
        screening_doctor_card_desc: 'Conclusión clínica detallada: diagnóstico diferencial, régimen farmacológico, interacciones y manejo.',
        screening_patient_card_title: 'Paciente / Público General',
        screening_patient_card_desc: 'Explicación clara y tranquilizadora, autocuidado, estilo de vida y orientación médica.',
        concluding_building: 'Generando conclusión...',
        concluding_step1_label: 'Resumiendo tus respuestas',
        concluding_step1_detail: 'Construyendo transcripción · reconociendo entidades clínicas',
        concluding_step2_label: 'Evaluando posible condición',
        concluding_step2_detail: 'Diagnóstico diferencial · razonamiento clínico',
        concluding_step3_label: 'Elaborando recomendaciones',
        concluding_step3_detail: 'Medicamentos / cuidados · seguridad · próximos pasos',
        concluding_step4_label: 'Conclusión lista para mostrar',
        concluding_step4_detail: 'JSON validado · informe adaptado a tu rol',
        concluding_wait: 'Por favor espera, preparando una conclusión adaptada a tu rol...',
        result_report_clinical: 'Informe Clínico',
        result_report_health: 'Informe de Salud',
        result_new_analysis: 'Nuevo Análisis',
        result_symptoms_described: 'Los síntomas que describiste',
        result_differential_title: 'Diagnóstico Diferencial',
        result_differential_desc: 'Posibles diagnósticos basados en los resultados del triaje',
        result_regimen_title: 'Régimen Farmacológico',
        result_regimen_desc: 'Toca un medicamento para ver todos los detalles',
        result_interactions_title: 'Interacciones Farmacológicas',
        result_management_title: 'Manejo Clínico',
        result_redflags_title: 'Signos de Alarma (Red Flags)',
        result_summary_title: 'Resumen Clínico',
        result_export_pdf_title: 'Documento Clínico',
        result_export_pdf_desc: 'Exporta este resumen formal para historias clínicas o derivaciones.',
        result_export_pdf_btn: 'PDF Clínico',
        result_likely_condition: 'Condición Probable',
        result_selfcare_title: 'Autocuidado',
        result_lifestyle_title: 'Ajustes de Estilo de Vida',
        result_seek_care_title: 'Cuándo Consultar al Médico',
        result_should_see_title: 'Especialista Recomendado',
        result_what_to_ask_title: 'Qué Preguntarle a tu Médico',
        result_facilities_title: 'Centros de Salud Cercanos',
        result_disclaimer: 'Este informe es solo para fines educativos. Consulta siempre a un profesional de la salud.',
        result_btn_copy: 'Copiar Informe',
        result_btn_copied: '¡Copiado al portapapeles!',
        result_btn_share: 'Compartir',
        result_btn_save_pdf: 'Guardar PDF',
        result_btn_start_over: 'Comenzar de Nuevo',
        kiosk_title: '¿Terminaste de leer?',
        kiosk_desc: 'Esta página se restablecerá automáticamente en {0} segundos para el siguiente usuario.',
        kiosk_wait: 'Esperar',
        kiosk_done: 'Listo',
        kiosk_hint: '"Esperar" añade 1 minuto más · "Listo" reinicia de inmediato',
        mc_facts_badge: 'Datos Médicos',
        mc_combo_badge: 'Datos + Evaluación',
        mc_patient_header: 'Para Pacientes / Público General',
        mc_self_care_header: 'Pasos de Autocuidado',
        mc_recommended_doctor: 'Médico recomendado:',
        mc_mode_clinician: 'Modo Clínico (Médicos / Profesionales)',
        mc_emergency_title: 'Condición de Emergencia Médica',
        mc_emergency_detected: 'Detectado por MediCore AI',
        mc_emergency_call_119: 'Llamar a Emergencias',
        mc_back: 'Volver',
    ...
    zh: {
        ...
        voice_tap_to_speak: '点击开始说话（支持多语言）',
        voice_recording_tap_stop: '正在录音：点击停止',
        voice_preparing_questions: '正在生成临床问诊问题...',
        voice_active_transcription: '语音转文字已开启',
        voice_recording_badge: '录音中',
        search_medicine_placeholder: '输入药品名称搜索...',
        search_button: '搜索',
        screening_header_title: '症状智能问诊',
        screening_question_of: '第 {0} 题，共 {1} 题',
        screening_your_symptoms: '您描述的症状',
        screening_select_multiple: '支持多选',
        screening_freetext_placeholder: '在此补充详细情况（选填）...',
        screening_btn_back: '上一题',
        screening_btn_continue: '继续',
        screening_btn_skip: '跳过',
        screening_final_step: '最后一步',
        screening_doctor_card_title: '医生 / 医护人员模式',
        screening_doctor_card_desc: '详细临床结论：鉴别诊断、药物方案、相互作用及管理建议。',
        screening_patient_card_title: '患者 / 大众模式',
        screening_patient_card_desc: '通俗易懂的病情解析、自我护理、生活建议及就医指导。',
        concluding_building: '正在生成临床评估结论...',
        concluding_step1_label: '汇总问诊回答',
        concluding_step1_detail: '整理问诊记录 · 识别临床实体',
        concluding_step2_label: '临床推论分析',
        concluding_step2_detail: '鉴别诊断 · 严重程度分级',
        concluding_step3_label: '制定建议方案',
        concluding_step3_detail: '用药指导 / 护理 · 安全性 · 后续步骤',
        concluding_step4_label: '临床评估准备就绪',
        concluding_step4_detail: '已验证JSON · 专为您定制的评估报告',
        concluding_wait: '请稍候，正在为您生成针对性的评估报告...',
        result_report_clinical: '临床专业报告',
        result_report_health: '健康评估报告',
        result_new_analysis: '开始新评估',
        result_symptoms_described: '您所描述的症状',
        result_differential_title: '鉴别诊断',
        result_differential_desc: '基于问诊结果推测的可能疾病',
        result_regimen_title: '药物治疗方案',
        result_regimen_desc: '点击药品名称查看完整详情',
        result_interactions_title: '药物相互作用',
        result_management_title: '临床处置与管理',
        result_redflags_title: '危险预警信号 (Red Flags)',
        result_summary_title: '临床总结',
        result_export_pdf_title: '临床文档导出',
        result_export_pdf_desc: '导出正式总结报告，供医疗记录或转诊使用。',
        result_export_pdf_btn: '导出临床PDF',
        result_likely_condition: '疑似病症',
        result_selfcare_title: '自我护理',
        result_lifestyle_title: '生活方式调整',
        result_seek_care_title: '就医时机指引',
        result_should_see_title: '建议就诊科室',
        result_what_to_ask_title: '问诊医生参考问题',
        result_facilities_title: '就近医疗机构',
        result_disclaimer: '本报告仅供健康教育参考，切勿替代执业医师的面诊与诊断。',
        result_btn_copy: '复制报告',
        result_btn_copied: '已复制到剪贴板！',
        result_btn_share: '分享',
        result_btn_save_pdf: '保存PDF',
        result_btn_start_over: '重新开始',
        kiosk_title: '阅读完成了吗？',
        kiosk_desc: '为了方便下一位使用者，本页面将在 {0} 秒后自动重置。',
        kiosk_wait: '稍等',
        kiosk_done: '完成',
        kiosk_hint: '“稍等”延长1分钟 · “完成”立即重置页面',
        mc_facts_badge: '医学事实',
        mc_combo_badge: '事实 + 问诊',
        mc_patient_header: '患者 / 大众健康指引',
        mc_self_care_header: '自我护理步骤',
        mc_recommended_doctor: '建议就诊科室：',
        mc_mode_clinician: '临床医生模式 (医生 / 医务工作者)',
        mc_emergency_title: '紧急医疗状况',
        mc_emergency_detected: '由 MediCore AI 识别',
        mc_emergency_call_119: '呼叫急救电话 (120/119)',
        mc_back: '返回',
    ...
    ar: {
        ...
        voice_tap_to_speak: 'انقر للتحدث (بأي لغة)',
        voice_recording_tap_stop: 'جارٍ التسجيل: انقر للإيقاف',
        voice_preparing_questions: 'جارٍ إعداد الأسئلة السريرية...',
        voice_active_transcription: 'النسخ الصوتي نشط',
        voice_recording_badge: 'تسجيل',
        search_medicine_placeholder: 'ابحث باسم الدواء...',
        search_button: 'بحث',
        screening_header_title: 'فرز الأعراض',
        screening_question_of: 'السؤال {0} من {1}',
        screening_your_symptoms: 'الأعراض التي وصفتها',
        screening_select_multiple: 'يمكنك اختيار أكثر من إجابة',
        screening_freetext_placeholder: 'أضف تفاصيل إضافية هنا (اختياري)...',
        screening_btn_back: 'رجوع',
        screening_btn_continue: 'متابعة',
        screening_btn_skip: 'تخطي',
        screening_final_step: 'الخطوة الأخيرة',
        screening_doctor_card_title: 'طبيب / ممارس صحي',
        screening_doctor_card_desc: 'خلاصة سريرية تفصيلية: التشخيص التفريقي، النظام الدوائي، التفاعلات، وخطة العلاج.',
        screening_patient_card_title: 'مريض / الجمهور العام',
        screening_patient_card_desc: 'شرح مبسط ومطمئن، نصائح العناية الذاتية، نمط الحياة، والتوجيه لزيارة الطبيب.',
        concluding_building: 'جارٍ بناء الخلاصة السريرية...',
        concluding_step1_label: 'تلخيص إجابات الفرز',
        concluding_step1_detail: 'بناء سجل الفرز · تحديد الكيانات السريرية',
        concluding_step2_label: 'تحليل الحالة المحتملة',
        concluding_step2_detail: 'التشخيص التفريقي · التفكير السريري',
        concluding_step3_label: 'صياغة التوصيات',
        concluding_step3_detail: 'الأدوية / الرعاية · السلامة · الخطوات التالية',
        concluding_step4_label: 'التقرير جاهز للعرض',
        concluding_step4_detail: 'تقرير مصمم خصيصاً لدورك وموثوق سريرياً',
        concluding_wait: 'يرجى الانتظار، جارٍ تحضير الخلاصة المخصصة لدورك...',
        result_report_clinical: 'تقرير سريري',
        result_report_health: 'تقرير صحي',
        result_new_analysis: 'تحليل جديد',
        result_symptoms_described: 'الأعراض التي وصفتها',
        result_differential_title: 'التشخيص التفريقي',
        result_differential_desc: 'التشخيصات المحتملة بناءً على نتائج الفرز',
        result_regimen_title: 'النظام الدوائي',
        result_regimen_desc: 'انقر على اسم الدواء لعرض التفاصيل الكاملة',
        result_interactions_title: 'التفاعلات الدوائية',
        result_management_title: 'التدبير العلاجي',
        result_redflags_title: 'علامات الخطر (Red Flags)',
        result_summary_title: 'الملخص السريري',
        result_export_pdf_title: 'تصدير المستند السريري',
        result_export_pdf_desc: 'تصدير هذا الملخص الرسمي للسجلات الطبية أو الإحالات.',
        result_export_pdf_btn: 'تحميل PDF السريري',
        result_likely_condition: 'الحالة المحتملة',
        result_selfcare_title: 'العناية الذاتية',
        result_lifestyle_title: 'تعديلات نمط الحياة',
        result_seek_care_title: 'متى يجب مراجعة الطبيب',
        result_should_see_title: 'التخصص الطبي الموصى به',
        result_what_to_ask_title: 'أسئلة مقترحة لطبيبك',
        result_facilities_title: 'المنشآت الصحية القريبة',
        result_disclaimer: 'هذا التقرير للأغراض التعليمية فقط ولا يغني عن استشارة الطبيب المختص.',
        result_btn_copy: 'نسخ التقرير',
        result_btn_copied: 'تم النسخ إلى الحافظة!',
        result_btn_share: 'مشاركة',
        result_btn_save_pdf: 'حفظ PDF',
        result_btn_start_over: 'البدء من جديد',
        kiosk_title: 'هل انتهيت من القراءة؟',
        kiosk_desc: 'ستتم إعادة ضبط هذه الصفحة تلقائياً خلال {0} ثانية لتكون جاهزة للشخص التالي.',
        kiosk_wait: 'انتظار',
        kiosk_done: 'تم',
        kiosk_hint: '"انتظار" يضيف دقيقة واحدة · "تم" يعيد الضبط فوراً',
        mc_facts_badge: 'حقائق طبية',
        mc_combo_badge: 'حقائق + فرز',
        mc_patient_header: 'للمرضى / الجمهور العام',
        mc_self_care_header: 'خطوات الرعاية الذاتية',
        mc_recommended_doctor: 'الطبيب الموصى به:',
        mc_mode_clinician: 'وضع الممارس الصحي (طبيب / كادر طبي)',
        mc_emergency_title: 'حالة طوارئ طبية',
        mc_emergency_detected: 'تم الكشف بواسطة MediCore AI',
        mc_emergency_call_119: 'اتصل بالطوارئ',
        mc_back: 'رجوع',
    ...
    fr: {
        ...
        voice_tap_to_speak: 'Appuyez pour parler (toutes langues)',
        voice_recording_tap_stop: 'Enregistrement en cours: appuyez pour arrêter',
        voice_preparing_questions: 'Préparation des questions cliniques...',
        voice_active_transcription: 'Transcription vocale active',
        voice_recording_badge: 'Enregistrement',
        search_medicine_placeholder: 'Rechercher par nom de médicament...',
        search_button: 'Rechercher',
        screening_header_title: 'Triage des Symptômes',
        screening_question_of: 'Question {0} sur {1}',
        screening_your_symptoms: 'Vos symptômes',
        screening_select_multiple: 'Vous pouvez sélectionner plusieurs options',
        screening_freetext_placeholder: 'Ajoutez des détails ici (facultatif)...',
        screening_btn_back: 'Retour',
        screening_btn_continue: 'Continuer',
        screening_btn_skip: 'Passer',
        screening_final_step: 'Dernière étape',
        screening_doctor_card_title: 'Médecin / Professionnel de Santé',
        screening_doctor_card_desc: 'Conclusion clinique approfondie: diagnostic différentiel, schéma posologique, interactions et prise en charge.',
        screening_patient_card_title: 'Patient / Grand Public',
        screening_patient_card_desc: 'Explications rassurantes, conseils d’autosoins, hygiène de vie et orientation vers un médecin.',
        concluding_building: 'Élaboration de la conclusion...',
        concluding_step1_label: 'Synthèse de vos réponses',
        concluding_step1_detail: 'Transcription du triage · reconnaissance des entités cliniques',
        concluding_step2_label: 'Analyse des pathologies suspectées',
        concluding_step2_detail: 'Diagnostic différentiel · raisonnement clinique',
        concluding_step3_label: 'Élaboration des recommandations',
        concluding_step3_detail: 'Traitements / soins · sécurité · étapes suivantes',
        concluding_step4_label: 'Conclusion prête à afficher',
        concluding_step4_detail: 'JSON validé · rapport adapté à votre profil',
        concluding_wait: 'Veuillez patienter, préparation d’une conclusion adaptée à votre profil...',
        result_report_clinical: 'Rapport Clinique',
        result_report_health: 'Rapport de Santé',
        result_new_analysis: 'Nouvelle Analyse',
        result_symptoms_described: 'Les symptômes que vous avez décrits',
        result_differential_title: 'Diagnostic Différentiel',
        result_differential_desc: 'Diagnostics possibles basés sur les résultats du triage',
        result_regimen_title: 'Schéma Thérapeutique',
        result_regimen_desc: 'Appuyez sur un médicament pour afficher les détails',
        result_interactions_title: 'Interactions Médicamenteuses',
        result_management_title: 'Prise en Charge Clinique',
        result_redflags_title: 'Signaux d’Alarme (Red Flags)',
        result_summary_title: 'Résumé Clinique',
        result_export_pdf_title: 'Document Clinique',
        result_export_pdf_desc: 'Exportez ce résumé formel pour les dossiers médicaux ou orientations.',
        result_export_pdf_btn: 'PDF Clinique',
        result_likely_condition: 'Pathologie Probable',
        result_selfcare_title: 'Autosoins et Précautions',
        result_lifestyle_title: 'Ajustements du Mode de Vie',
        result_seek_care_title: 'Quand Consulter un Médecin',
        result_should_see_title: 'Spécialiste Recommandé',
        result_what_to_ask_title: 'Questions à Poser à Votre Médecin',
        result_facilities_title: 'Établissements de Santé Proches',
        result_disclaimer: 'Ce rapport est fourni à titre éducatif uniquement. Consultez toujours un professionnel de santé.',
        result_btn_copy: 'Copier le Rapport',
        result_btn_copied: 'Copié dans le presse-papier !',
        result_btn_share: 'Partager',
        result_btn_save_pdf: 'Enregistrer en PDF',
        result_btn_start_over: 'Recommencer',
        kiosk_title: 'Avez-vous terminé ?',
        kiosk_desc: 'Cette page se réinitialisera automatiquement dans {0} secondes pour le prochain utilisateur.',
        kiosk_wait: 'Attendre',
        kiosk_done: 'Terminé',
        kiosk_hint: '« Attendre » ajoute 1 minute · « Terminé » réinitialise immédiatement',
        mc_facts_badge: 'Faits Médicaux',
        mc_combo_badge: 'Faits + Triage',
        mc_patient_header: 'Pour le Patient / Grand Public',
        mc_self_care_header: 'Étapes d’Autosoins',
        mc_recommended_doctor: 'Médecin recommandé :',
        mc_mode_clinician: 'Mode Clinicien (Médecins / Soignants)',
        mc_emergency_title: 'Urgence Médicale',
        mc_emergency_detected: 'Détecté par MediCore AI',
        mc_emergency_call_119: 'Appeler les Urgences (15/112)',
        mc_back: 'Retour',
    ...
    de: {
        ...
        voice_tap_to_speak: 'Tippen zum Sprechen (jede Sprache)',
        voice_recording_tap_stop: 'Aufnahme läuft: Tippen zum Beenden',
        voice_preparing_questions: 'Klinische Fragen werden vorbereitet...',
        voice_active_transcription: 'Sprachtranskription aktiv',
        voice_recording_badge: 'Aufnahme',
        search_medicine_placeholder: 'Nach Medikamentennamen suchen...',
        search_button: 'Suchen',
        screening_header_title: 'Symptom-Triage & Screening',
        screening_question_of: 'Frage {0} von {1}',
        screening_your_symptoms: 'Ihre Symptome',
        screening_select_multiple: 'Mehrfachauswahl möglich',
        screening_freetext_placeholder: 'Zusätzliche Details eingeben (optional)...',
        screening_btn_back: 'Zurück',
        screening_btn_continue: 'Weiter',
        screening_btn_skip: 'Überspringen',
        screening_final_step: 'Letzter Schritt',
        screening_doctor_card_title: 'Arzt / Medizinisches Fachpersonal',
        screening_doctor_card_desc: 'Detaillierte klinische Schlussfolgerung: Differentialdiagnose, Medikation, Interaktionen und Management.',
        screening_patient_card_title: 'Patient / Allgemeine Öffentlichkeit',
        screening_patient_card_desc: 'Verständliche Erklärung, Selbstfürsorge, Lebensstil-Tipps und Empfehlungen zum Arztbesuch.',
        concluding_building: 'Klinische Beurteilung wird erstellt...',
        concluding_step1_label: 'Zusammenfassung Ihrer Antworten',
        concluding_step1_detail: 'Triage-Protokoll · Erkennung klinischer Entitäten',
        concluding_step2_label: 'Analyse möglicher Erkrankungen',
        concluding_step2_detail: 'Differentialdiagnose · klinische Evidenz',
        concluding_step3_label: 'Erstellung von Empfehlungen',
        concluding_step3_detail: 'Medikamente / Pflege · Sicherheit · nächste Schritte',
        concluding_step4_label: 'Abschlussbericht bereit',
        concluding_step4_detail: 'Validiertes JSON · auf Ihre Rolle zugeschnittener Bericht',
        concluding_wait: 'Bitte warten, die auf Ihre Rolle abgestimmte Zusammenfassung wird vorbereitet...',
        result_report_clinical: 'Klinischer Bericht',
        result_report_health: 'Gesundheitsbericht',
        result_new_analysis: 'Neue Analyse',
        result_symptoms_described: 'Ihre geschilderten Symptome',
        result_differential_title: 'Differentialdiagnose',
        result_differential_desc: 'Mögliche Differentialdiagnosen basierend auf dem Screening',
        result_regimen_title: 'Pharmakologisches Regime',
        result_regimen_desc: 'Tippen Sie auf ein Medikament für vollständige Details',
        result_interactions_title: 'Arzneimittel-Interaktionen',
        result_management_title: 'Klinisches Management',
        result_redflags_title: 'Warnsignale (Red Flags)',
        result_summary_title: 'Klinische Zusammenfassung',
        result_export_pdf_title: 'Klinisches Dokument',
        result_export_pdf_desc: 'Exportieren Sie diese Zusammenfassung für Krankenakten oder Überweisungen.',
        result_export_pdf_btn: 'Klinisches PDF',
        result_likely_condition: 'Wahrscheinliches Krankheitsbild',
        result_selfcare_title: 'Selbstfürsorge & Maßnahmen',
        result_lifestyle_title: 'Lebensstilanpassungen',
        result_seek_care_title: 'Wann ein Arzt aufzusuchen ist',
        result_should_see_title: 'Empfohlener Facharzt',
        result_what_to_ask_title: 'Fragen für das Arztgespräch',
        result_facilities_title: 'Medizinische Einrichtungen in der Nähe',
        result_disclaimer: 'Dieser Bericht dient ausschließlich zu Bildungszwecken. Konsultieren Sie immer einen Arzt.',
        result_btn_copy: 'Bericht kopieren',
        result_btn_copied: 'In die Zwischenablage kopiert!',
        result_btn_share: 'Teilen',
        result_btn_save_pdf: 'PDF speichern',
        result_btn_start_over: 'Neu starten',
        kiosk_title: 'Fertig gelesen?',
        kiosk_desc: 'Diese Seite wird in {0} Sekunden automatisch für die nächste Person zurückgesetzt.',
        kiosk_wait: 'Warten',
        kiosk_done: 'Fertig',
        kiosk_hint: '„Warten“ verlängert um 1 Minute · „Fertig“ setzt sofort zurück',
        mc_facts_badge: 'Medizinische Fakten',
        mc_combo_badge: 'Fakten + Screening',
        mc_patient_header: 'Für Patienten / Allgemeinheit',
        mc_self_care_header: 'Schritte zur Selbstpflege',
        mc_recommended_doctor: 'Empfohlener Facharzt:',
        mc_mode_clinician: 'Klinikermodus (Ärzte / Fachpersonal)',
        mc_emergency_title: 'Medizinischer Notfall',
        mc_emergency_detected: 'Erkannt durch MediCore AI',
        mc_emergency_call_119: 'Notruf wählen (112)',
        mc_back: 'Zurück',
    ...
    ko: {
        ...
        voice_tap_to_speak: '탭하여 음성으로 입력 (모든 언어 지원)',
        voice_recording_tap_stop: '녹음 중: 탭하여 중지',
        voice_preparing_questions: '임상 질문을 준비 중입니다...',
        voice_active_transcription: '음성 인식 활성화',
        voice_recording_badge: '녹음 중',
        search_medicine_placeholder: '의약품명으로 검색...',
        search_button: '검색',
        screening_header_title: '증상 AI 문진',
        screening_question_of: '질문 {0} / {1}',
        screening_your_symptoms: '입력하신 증상',
        screening_select_multiple: '복수 선택이 가능합니다',
        screening_freetext_placeholder: '추가 증상이나 세부사항 입력 (선택)...',
        screening_btn_back: '이전',
        screening_btn_continue: '다음 단계',
        screening_btn_skip: '건너뛰기',
        screening_final_step: '마지막 단계',
        screening_doctor_card_title: '의사 / 의료진 모드',
        screening_doctor_card_desc: '감별 진단, 약물 요법, 상호작용 및 관리 지침을 포함한 상세 임상 소견서.',
        screening_patient_card_title: '환자 / 일반인 모드',
        screening_patient_card_desc: '이해하기 쉬운 설명, 자가 관리법, 생활 습관 안내 및 권장 진료과.',
        concluding_building: '임상 평가를 작성하고 있습니다...',
        concluding_step1_label: '문진 응답 정리 및 요약',
        concluding_step1_detail: '문진 기록 구성 · 임상 엔터티 인식',
        concluding_step2_label: '의심 질환 임상 추론',
        concluding_step2_detail: '감별 진단 도출 · 중증도 평가',
        concluding_step3_label: '치료 및 관리 권고사항 작성',
        concluding_step3_detail: '추천 약물 / 케어 · 안전성 검토 · 다음 조치',
        concluding_step4_label: '임상 평가 준비 완료',
        concluding_step4_detail: '검증된 JSON · 역할에 맞춘 맞춤형 리포트',
        concluding_wait: '선택하신 역할에 최적화된 평가서를 작성 중입니다. 잠시만 기다려주세요...',
        result_report_clinical: '임상 소견서',
        result_report_health: '건강 평가서',
        result_new_analysis: '새로운 분석 시작',
        result_symptoms_described: '입력하신 증상 요약',
        result_differential_title: '감별 진단',
        result_differential_desc: '문진 결과에 기반한 가능성 있는 질환군',
        result_regimen_title: '약물 치료 요법',
        result_regimen_desc: '약물명을 탭하여 상세 정보를 확인하세요',
        result_interactions_title: '약물 상호작용',
        result_management_title: '임상 처치 및 관리',
        result_redflags_title: '위험 징후 (Red Flags)',
        result_summary_title: '임상 요약',
        result_export_pdf_title: '임상 문서 내보내기',
        result_export_pdf_desc: '진료 기록 또는 의뢰서용 정식 소견서를 PDF로 다운로드합니다.',
        result_export_pdf_btn: '임상 PDF 저장',
        result_likely_condition: '의심 질환',
        result_selfcare_title: '자가 관리 요령',
        result_lifestyle_title: '생활 습관 개선안',
        result_seek_care_title: '병원 방문이 필요한 시점',
        result_should_see_title: '추천 진료과',
        result_what_to_ask_title: '담당 의사에게 질문할 항목',
        result_facilities_title: '인근 의료기관',
        result_disclaimer: '본 리포트는 교육 및 참고용이며, 전문의의 진단과 치료를 대신할 수 없습니다.',
        result_btn_copy: '결과 복사',
        result_btn_copied: '클립보드에 복사되었습니다!',
        result_btn_share: '공유하기',
        result_btn_save_pdf: 'PDF 저장',
        result_btn_start_over: '처음부터 다시',
        kiosk_title: '확인을 완료하셨습니까?',
        kiosk_desc: '다음 이용자를 위해 이 페이지는 {0}초 후 자동으로 초기화됩니다.',
        kiosk_wait: '연장',
        kiosk_done: '완료',
        kiosk_hint: '“연장”은 1분 추가 · “완료”는 즉시 초기화',
        mc_facts_badge: '의학 정보',
        mc_combo_badge: '정보 + 문진',
        mc_patient_header: '환자 / 일반인 가이드',
        mc_self_care_header: '자가 관리 지침',
        mc_recommended_doctor: '추천 진료과:',
        mc_mode_clinician: '의료진 모드 (의사 / 전문 의료진)',
        mc_emergency_title: '응급 의료 상태',
        mc_emergency_detected: 'MediCore AI 감지',
        mc_emergency_call_119: '119 응급 전화',
        mc_back: '뒤로가기',
    ...
    pt: {
        ...
        voice_tap_to_speak: 'Toque para falar (qualquer idioma)',
        voice_recording_tap_stop: 'Gravando: toque para parar',
        voice_preparing_questions: 'Preparando perguntas clínicas...',
        voice_active_transcription: 'Transcrição de voz ativa',
        voice_recording_badge: 'Gravando',
        search_medicine_placeholder: 'Buscar por nome do medicamento...',
        search_button: 'Buscar',
        screening_header_title: 'Triagem de Sintomas',
        screening_question_of: 'Pergunta {0} de {1}',
        screening_your_symptoms: 'Seus sintomas',
        screening_select_multiple: 'Você pode selecionar mais de uma opção',
        screening_freetext_placeholder: 'Adicione seus detalhes aqui (opcional)...',
        screening_btn_back: 'Voltar',
        screening_btn_continue: 'Continuar',
        screening_btn_skip: 'Pular',
        screening_final_step: 'Etapa final',
        screening_doctor_card_title: 'Médico / Profissional de Saúde',
        screening_doctor_card_desc: 'Conclusão clínica detalhada: diagnóstico diferencial, regime de medicamentos, interações e conduta.',
        screening_patient_card_title: 'Paciente / Público Geral',
        screening_patient_card_desc: 'Explicação clara e tranquilizadora, autocuidado, estilo de vida e orientação para consulta.',
        concluding_building: 'Gerando conclusão clínica...',
        concluding_step1_label: 'Sintetizando suas respostas',
        concluding_step1_detail: 'Estruturação do relatório · reconhecimento de entidades clínicas',
        concluding_step2_label: 'Análise de condições prováveis',
        concluding_step2_detail: 'Diagnóstico diferencial · raciocínio clínico',
        concluding_step3_label: 'Elaboração de recomendações',
        concluding_step3_detail: 'Medicamentos / cuidados · segurança · próximos passos',
        concluding_step4_label: 'Conclusão pronta para exibição',
        concluding_step4_detail: 'JSON validado · relatório adaptado ao seu perfil',
        concluding_wait: 'Aguarde, preparando uma conclusão personalizada para o seu perfil...',
        result_report_clinical: 'Relatório Clínico',
        result_report_health: 'Relatório de Saúde',
        result_new_analysis: 'Nova Análise',
        result_symptoms_described: 'Os sintomas que você descreveu',
        result_differential_title: 'Diagnóstico Diferencial',
        result_differential_desc: 'Possíveis hipóteses diagnósticas com base na triagem',
        result_regimen_title: 'Regime Farmacológico',
        result_regimen_desc: 'Toque no nome do medicamento para ver os detalhes completos',
        result_interactions_title: 'Interações Medicamentosas',
        result_management_title: 'Conduta e Manejo',
        result_redflags_title: 'Sinais de Alerta (Red Flags)',
        result_summary_title: 'Resumo Clínico',
        result_export_pdf_title: 'Documento Clínico',
        result_export_pdf_desc: 'Exporte este resumo formal para prontuários ou encaminhamentos.',
        result_export_pdf_btn: 'PDF Clínico',
        result_likely_condition: 'Condição Provável',
        result_selfcare_title: 'Autocuidado',
        result_lifestyle_title: 'Ajustes no Estilo de Vida',
        result_seek_care_title: 'Quando Procurar Atendimento Médico',
        result_should_see_title: 'Especialista Recomendado',
        result_what_to_ask_title: 'O que Perguntar ao seu Médico',
        result_facilities_title: 'Unidades de Saúde Próximas',
        result_disclaimer: 'Este relatório é apenas para fins educativos. Consulte sempre um profissional de saúde.',
        result_btn_copy: 'Copiar Relatório',
        result_btn_copied: 'Copiado para a área de transferência!',
        result_btn_share: 'Compartilhar',
        result_btn_save_pdf: 'Salvar PDF',
        result_btn_start_over: 'Recomeçar',
        kiosk_title: 'Terminou a leitura?',
        kiosk_desc: 'Esta página será redefinida automaticamente em {0} segundos para a próxima pessoa.',
        kiosk_wait: 'Aguardar',
        kiosk_done: 'Concluído',
        kiosk_hint: '"Aguardar" adiciona mais 1 minuto · "Concluído" reinicia agora',
        mc_facts_badge: 'Fatos Médicos',
        mc_combo_badge: 'Fatos + Triagem',
        mc_patient_header: 'Para Pacientes / Público Geral',
        mc_self_care_header: 'Passos de Autocuidado',
        mc_recommended_doctor: 'Médico recomendado:',
        mc_mode_clinician: 'Modo Clínico (Médicos / Profissionais de Saúde)',
        mc_emergency_title: 'Emergência Médica',
        mc_emergency_detected: 'Detectado pelo MediCore AI',
        mc_emergency_call_119: 'Ligue para Emergência (192)',
        mc_back: 'Voltar',
    ...
    ru: {
        ...
        voice_tap_to_speak: 'Нажмите, чтобы говорить (любой язык)',
        voice_recording_tap_stop: 'Запись: нажмите для остановки',
        voice_preparing_questions: 'Подготовка клинических вопросов...',
        voice_active_transcription: 'Голосовая расшифровка активна',
        voice_recording_badge: 'Запись',
        search_medicine_placeholder: 'Поиск по названию препарата...',
        search_button: 'Найти',
        screening_header_title: 'Скрининг Симптомов',
        screening_question_of: 'Вопрос {0} из {1}',
        screening_your_symptoms: 'Ваши симптомы',
        screening_select_multiple: 'Можно выбрать несколько вариантов',
        screening_freetext_placeholder: 'Добавьте детали здесь (необязательно)...',
        screening_btn_back: 'Назад',
        screening_btn_continue: 'Продолжить',
        screening_btn_skip: 'Пропустить',
        screening_final_step: 'Завершающий шаг',
        screening_doctor_card_title: 'Врач / Медицинский специалист',
        screening_doctor_card_desc: 'Подробное клиническое заключение: дифференциальный диагноз, схема терапии, взаимодействия и тактика ведения.',
        screening_patient_card_title: 'Пациент / Общая информация',
        screening_patient_card_desc: 'Понятное и взвешенное объяснение, рекомендации по уходу, образу жизни и направлению к врачу.',
        concluding_building: 'Формирование клинического заключения...',
        concluding_step1_label: 'Сводка ответов скрининга',
        concluding_step1_detail: 'Формирование транскрипта · распознавание клинических сущностей',
        concluding_step2_label: 'Анализ вероятных состояний',
        concluding_step2_detail: 'Дифференциальный диагноз · клиническое обоснование',
        concluding_step3_label: 'Формирование рекомендаций',
        concluding_step3_detail: 'Препараты / уход · безопасность · следующие шаги',
        concluding_step4_label: 'Заключение готово к просмотру',
        concluding_step4_detail: 'Проверенный JSON · отчет, адаптированный под вашу роль',
        concluding_wait: 'Пожалуйста, подождите, формируется отчет, адаптированный под вашу роль...',
        result_report_clinical: 'Клинический отчет',
        result_report_health: 'Медицинский отчет',
        result_new_analysis: 'Новый анализ',
        result_symptoms_described: 'Описанные вами симптомы',
        result_differential_title: 'Дифференциальный диагноз',
        result_differential_desc: 'Возможные заболевания на основе результатов скрининга',
        result_regimen_title: 'Фармакологический режим',
        result_regimen_desc: 'Нажмите на название препарата для подробностей',
        result_interactions_title: 'Лекарственные взаимодействия',
        result_management_title: 'Клинический менеджмент',
        result_redflags_title: 'Тревожные признаки (Red Flags)',
        result_summary_title: 'Клиническое резюме',
        result_export_pdf_title: 'Клинический документ',
        result_export_pdf_desc: 'Экспортируйте официальное заключение для амбулаторной карты или направления.',
        result_export_pdf_btn: 'Клинический PDF',
        result_likely_condition: 'Вероятное заболевание',
        result_selfcare_title: 'Самопомощь и уход',
        result_lifestyle_title: 'Коррекция образа жизни',
        result_seek_care_title: 'Когда обратиться к врачу',
        result_should_see_title: 'Рекомендуемый специалист',
        result_what_to_ask_title: 'Что спросить у врача',
        result_facilities_title: 'Ближайшие медицинские учреждения',
        result_disclaimer: 'Этот отчет носит исключительно ознакомительный характер. Всегда консультируйтесь с врачом.',
        result_btn_copy: 'Копировать отчет',
        result_btn_copied: 'Скопировано в буфер обмена!',
        result_btn_share: 'Поделиться',
        result_btn_save_pdf: 'Сохранить PDF',
        result_btn_start_over: 'Начать сначала',
        kiosk_title: 'Завершили ознакомление?',
        kiosk_desc: 'Эта страница автоматически перезагрузится через {0} сек для следующего пользователя.',
        kiosk_wait: 'Подождать',
        kiosk_done: 'Готово',
        kiosk_hint: '«Подождать» добавит 1 минуту · «Готово» перезагрузит сразу',
        mc_facts_badge: 'Медицинские факты',
        mc_combo_badge: 'Факты + Скрининг',
        mc_patient_header: 'Для пациентов и широкой аудитории',
        mc_self_care_header: 'Рекомендации по самопомощи',
        mc_recommended_doctor: 'Рекомендуемый врач:',
        mc_mode_clinician: 'Режим клинициста (Врачи / Медперсонал)',
        mc_emergency_title: 'Неотложное медицинское состояние',
        mc_emergency_detected: 'Определено MediCore AI',
        mc_emergency_call_119: 'Вызов скорой помощи (112/103)',
        mc_back: 'Назад',
...
const PHARMASIS_PLACEHOLDER_EXAMPLES = {
    "en": [
        "Example: \"I've had a dry cough and a 38°C fever since yesterday...\"",
    ...
    "id": [
        "Contoh: \"Saya mengalami batuk kering dan demam 38°C sejak kemarin...\"",
        "Contoh: \"Perut kanan bawah sangat nyeri, mual, dan muntah dua kali...\"",
        "Contoh: \"Hidung tersumbat, bersin tiap pagi, riwayat asma ringan...\"",
        "Contoh: \"Kepala terasa berputar saat bangun tidur dan telinga berdenging...\""
    ],
    "ja": [
        "例: 「昨日から38度の熱と乾いた咳が続いています...」",
        "例: 「右下腹部が激しく痛み、吐き気がして2回嘔吐しました...」",
        "例: 「毎朝鼻づまりとくしゃみがあり、軽い喘息の既往歴があります...」",
        "例: 「朝起き上がると天井がぐるぐる回り、耳鳴りがします...」"
    ],
    "es": [
        "Ejemplo: \"Tengo tos seca y fiebre de 38°C desde ayer...\"",
        "Ejemplo: \"Me duele mucho el abdomen inferior derecho, tengo náuseas y vomité dos veces...\"",
        "Ejemplo: \"Nariz tapada, estornudos cada mañana, con antecedentes de asma leve...\"",
        "Ejemplo: \"Siento que todo gira al levantarme de la cama y me zumban los oídos...\""
    ],
    "zh": [
        "示例：“从昨天开始持续干咳，并且体温达到38°C……”",
        "示例：“右下腹剧烈疼痛，伴有恶心并呕吐了两次……”",
        "示例：“每天早晨鼻塞打喷嚏，既往有轻度哮喘病史……”",
        "示例：“早晨起床时感到天旋地转，并伴有耳鸣……”"
    ],
    "ar": [
        "مثال: \"أعاني من سعال جاف وحمى 38 درجة مئوية منذ يوم أمس...\"",
        "مثال: \"ألم شديد أسفل يمين البطن مع غثيان وتقيأت مرتين...\"",
        "مثال: \"انسداد في الأنف وعطاس كل صباح مع تاريخ من الربو الخفيف...\"",
        "مثال: \"أشعر بدوار شديد عند النهوض من السرير مع طنين في الأذن...\""
    ],
    "fr": [
        "Exemple : \"J'ai une toux sèche et 38°C de fièvre depuis hier...\"",
        "Exemple : \"Forte douleur au bas-ventre droit, nausées et j'ai vomi deux fois...\"",
        "Exemple : \"Nez bouché, éternuements chaque matin, antécédent d'asthme léger...\"",
        "Exemple : \"Vertiges au lever du lit et bourdonnements d'oreilles...\""
    ],
    "de": [
        "Beispiel: \"Ich habe seit gestern Reizhusten und 38°C Fieber...\"",
        "Beispiel: \"Starke Schmerzen im rechten Unterbauch, Übelkeit und zweimal erbrochen...\"",
        "Beispiel: \"Verstopfte Nase, Niesen jeden Morgen, leichte Asthma-Vorgeschichte...\"",
        "Beispiel: \"Drehschwindel beim Aufstehen und Ohrensausen...\""
    ],
    "ko": [
        "예시: \"어제부터 마른 기침이 나고 38도 열이 납니다...\"",
        "예시: \"오른쪽 아랫배가 심하게 아프고 메스꺼우며 두 번 구토했습니다...\"",
        "예시: \"매일 아침 코가 막히고 재채기가 나며, 가벼운 천식 병력이 있습니다...\"",
        "예시: \"아침에 일어날 때 머리가 핑 돌고 귀에서 삐 소리가 납니다...\""
    ],
    "pt": [
        "Exemplo: \"Estou com tosse seca e febre de 38°C desde ontem...\"",
        "Exemplo: \"Dor forte no abdômen inferior direito, náuseas e vomitei duas vezes...\"",
        "Exemplo: \"Nariz entupido, espirros todas as manhãs e histórico de asma leve...\"",
        "Exemplo: \"Sinto tontura ao levantar da cama e zumbido nos ouvidos...\""
    ],
    "ru": [
        "Пример: «Со вчерашнего дня сухой кашель и температура 38°C...»",
        "Пример: «Сильная боль внизу живота справа, тошнота и дважды была рвота...»",
        "Пример: «Заложенность носа, чихание по утрам, в анамнезе легкая астма...»",
        "Пример: «Головокружение при подъеме с постели и шум в ушах...»"
    ]
};

window.PharmasisI18n = {
    placeholderExamples: PHARMASIS_PLACEHOLDER_EXAMPLES,
    ...
    init() {
        ...
        const cookieMatch = document.cookie.match(/(?:^|;\s*)pharmasis_lang=([^;]+)/);
        const cookieLang = cookieMatch ? cookieMatch[1] : null;
        const validCodes = PHARMASIS_LANGUAGES.map(l => l.code);
        
        if (urlLang && validCodes.includes(urlLang.toLowerCase())) {
            this.currentLang = urlLang.toLowerCase();
            localStorage.setItem('pharmasis_lang', this.currentLang);
            document.cookie = 'pharmasis_lang=' + this.currentLang + ';path=/;max-age=31536000';
        } else if (saved && validCodes.includes(saved)) {
            this.currentLang = saved;
        } else if (cookieLang && validCodes.includes(cookieLang)) {
    ...
    setLanguage(targetCode) {
        ...
        this.showPreloader(fromLang, toLang, () => {
            ...
            document.cookie = 'pharmasis_lang=' + targetCode + ';path=/;max-age=31536000';
    ...
    /**
     * Minimalist iOS-style Frosted Glass Preloader (~150ms duration)
     */
    ...
    getExamples(lang = this.currentLang) {
        return PHARMASIS_PLACEHOLDER_EXAMPLES[lang] || PHARMASIS_PLACEHOLDER_EXAMPLES['en'] || [];
    }
};
